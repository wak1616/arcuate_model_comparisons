...
"""## Part 2: Building a model that predicts Arcuate Sweep with monotonicity constraints"""

# Define monotonicity constraints (1 for positive monotonic, -1 for negative, 0 for no constraint)
# Update constraints for all requested features
...
monotonic_constraints['Treated_astig'] = 1  # Strong positive correlation (0.891974)
...
# Note: These optimized parameters and features are now enhanced with additional monotonicity constraints
# The constraints ensure realistic relationships between features and the predicted arcuate sweep
...
print("\n" + "="*60)
print("ARCUATE SWEEP PREDICTION MODEL WITH SELECTED MONOTONICITY CONSTRAINTS")
print("="*60)
print("\nThis model enforces monotonicity on selected features based on their clinical significance:")
print("• 'Treated_astig' (+): Enforces that higher astigmatism predicts larger arcuate sweep")
print("\nThis monotonicity constraint ensures the model makes predictions that follow the most important clinical relationship.")
